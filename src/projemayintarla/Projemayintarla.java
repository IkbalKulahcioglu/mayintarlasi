...
public class Projemayintarla implements ActionListener{

	JFrame cerceve = new JFrame("MayinTarlasi");
	JButton reset = new JButton("Yenile");
	JButton[][] butonlar  = new JButton[16][16];
	int[][] kutu = new int[16][16]; 
	Container izgara = new Container();
	final int MAYIN = 40;
	
	public Projemayintarla(){
    ...
    public void rastgeleMayinOlustur(){
